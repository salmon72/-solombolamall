...
$(document).ready(function(){
    ...
    $(".icon_button").on('click touchstart', function() {
        $(".mobile-menu").addClass('open');
        $("body").addClass('open-menu');
        $(this).addClass('clicked');
    });
    $(".close_menu-button").on('click touchstart', function() {
...
$(document).ready(function(){
    $(".head_search-mobile").on('touchstart', function() {
        $(".search_mobile").toggleClass('opened_search');
        $(".yellow_block").toggleClass('opened_search');
        $("body").toggleClass('opened_search');
        $(this).toggleClass('opened_search');
    });
});

$(document).ready(function(){
    $(".head_search").on('click touchstart', function() {
        $(".header_search").addClass('open');
        $(".yellow_block").addClass('open');
        $("body").addClass('open');
    });
    $(".close_search").on('click touchstart', function() {
        $(".header_search").removeClass('open');
        $(".yellow_block").removeClass('open');
        $("body").removeClass('open');
    });
});

$(document).ready(function(){
    $('.otdely_category-name').click(function(){
        if($('.otdely_category-name').hasClass('active')){
            $('.otdely_category-name').removeClass('active');
...
>>>>>>> 66601ca863bd0b55dc0bfc10bfdaa642a9bc9ece
